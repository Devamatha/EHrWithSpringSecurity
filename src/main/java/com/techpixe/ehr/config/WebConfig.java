	...
	public void addInterceptors(InterceptorRegistry registry) {
		registry.addInterceptor(subscriptionInterceptor)
				.addPathPatterns("/api/JobDetails/addJob/**", "/api/JobDetails/update/**", "/api/JobDetails/delete/**",
						...
						"/api/clients/save/Employee/**","/api/notifications/send/{userId}",
						"/api/notifications/send/**", "/api/payheads/user/**",
						"/api/candidates/upload-resume/**", "/api/candidates/update-Details/**",
						"/api/subscriptions/save/**", "/api/addPayHeadsToEmployee/employeeData/**",
						"/api/payHeads/user/**", "/api/payHeads/delete/**", "/api/payHeads/update/**",
						"/api/leaveApproval/status/**", "/api/attendance/employee/**", "/api/attendance/update/**",
