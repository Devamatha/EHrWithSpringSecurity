    ...
    SecurityFilterChain defaultSecurityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .csrf(csrf -> csrf.csrfTokenRequestHandler(csrfTokenRequestAttributeHandler).
                        ignoringRequestMatchers("/api/users/user","/api/users/apiLogin","/api/users/login").csrfTokenRepository(CookieCsrfTokenRepository.withHttpOnlyFalse()))
...
//                                requestMatchers("/getNotices").hasRole("USER").
                                requestMatchers("/api/users/user","/api/users/apiLogin","/api/users/login").permitAll());
